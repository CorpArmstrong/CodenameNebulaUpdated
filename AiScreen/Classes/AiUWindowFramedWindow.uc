//=============================================================================
// AiUWindowFramedWindow - a Windows95 style framed window
//=============================================================================
class AiUWindowFramedWindow extends AiUWindowWindow;


var class<AiUWindowWindow>	ClientClass;
var AiUWindowWindow			ClientArea;
...
var bool					bSizable;
var bool					bStatusBar;
var AiUWindowFrameCloseBox	CloseBox;
...
function Created()
{
	...
	CloseBox = AiUWindowFrameCloseBox(CreateWindow(class'AiUWindowFrameCloseBox', WinWidth-20, WinHeight-20, 11, 10));
}
...
defaultproperties
{
     ClientClass=class'AiUWindow.UWindowClientWindow'
}
