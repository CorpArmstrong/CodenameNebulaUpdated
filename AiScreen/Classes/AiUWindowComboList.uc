class AiUWindowComboList extends AiUWindowListControl;

var AiUWindowComboControl		Owner;
var AiUWindowVScrollBar		VertSB;
var AiUWindowComboListItem	Selected;
var int ItemHeight;
var int VBorder;
var int HBorder;
var int TextBorder;
...
function Setup()
{
	VertSB = AiUWindowVScrollBar(CreateWindow(class'AiUWindowVScrollBar', 0, WinWidth - 16, 16, WinHeight));
}

function Created()
{
	ListClass = class'AiUWindowComboListItem';
	bAlwaysOnTop = True;
	bTransient = True;
	Super.Created();
	ItemHeight = 15;
...
{
	local AiUWindowComboListItem I;
	local int Count;

	I = AiUWindowComboListItem(Items.Next);
	Count = 0;
	...
	while(I != None)
	{
		...
		Count++;
		I = AiUWindowComboListItem(I.Next);
	}
...
{
	local AiUWindowComboListItem I;
	I = AiUWindowComboListItem(Items.Append(class'AiUWindowComboListItem'));
	I.Value = Value;
	I.Value2 = Value2;
...
{
	local AiUWindowComboListItem I;
	I = AiUWindowComboListItem(Items.Insert(class'AiUWindowComboListItem'));
	I.Value = Value;
	I.Value2 = Value2;
	I.SortWeight = SortWeight;
}
...
{
	local AiUWindowComboListItem NewSelected, Item;
	local int i, Count;

	Count = 0;
	for( Item = AiUWindowComboListItem(Items.Next);Item != None; Item = AiUWindowComboListItem(Item.Next) )
		Count++;
	...
	NewSelected = AiUWindowComboListItem(Items.FindEntry(i));
...
function BeforePaint(Canvas C, float X, float Y)
{
	...
	for( I = AiUWindowComboListItem(Items.Next);I != None; I = AiUWindowComboListItem(I.Next) )
	{
...
{
	LookAndFeel.ComboList_DrawItem(Self, C, X, Y, W, H, AiUWindowComboListItem(Item).Value, Selected == Item);
}

function ExecuteItem(AiUWindowComboListItem I)
{
