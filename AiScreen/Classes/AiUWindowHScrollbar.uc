//=============================================================================
// AiUWindowHScrollBar - A horizontal scrollbar
//=============================================================================
class AiUWindowHScrollBar extends AiUWindowWindow;

var AiUWindowSBLeftButton		LeftButton;
var AiUWindowSBRightButton	RightButton;
var bool					bDisabled;
var float					MinPos;
var float					MaxPos;
...
{
	Super.Created();
	LeftButton = AiUWindowSBLeftButton(CreateWindow(class'AiUWindowSBLeftButton', 0, 0, 10, 12));
	RightButton = AiUWindowSBRightButton(CreateWindow(class'AiUWindowSBRightButton', WinWidth-10, 0, 10, 12));
}
