...
//=============================================================================
class AugSkullGunNonLethal extends Augmentation;
...
function Activate() //Doesn't need to be overridden, but it makes things easier to do it here.
{
	...
	//== Set some variables
	ProjClass = Class'DeusEx.GreaselSpit';
	...
	Player.PlaySound(sound'DeusExSounds.Animal.GreaselShoot',,perc,, 1280 * perc);
}
...
defaultproperties
{
     ...
     AugmentationName="Greasel Skull Gun"
     Description="Nano factories programmed to assemble a toxic mass and form it into a projectile that paralyses the nervous system of the victim.|n|nTECH ONE: Energy consumption is high.|n|nTECH TWO: Energy consumption is lowered.|n|nTECH THREE: Energy consumption is lowered further.|n|nTECH FOUR: Energy consumption is minimal."
     MPInfo="Fires a toxic projectile from the cranial area.  Energy Drain: High"
