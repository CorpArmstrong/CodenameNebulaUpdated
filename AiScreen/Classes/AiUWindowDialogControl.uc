//=============================================================================
// AiUWindowDialogControl - a control which notifies a dialog control group
//=============================================================================
class AiUWindowDialogControl extends AiUWindowWindow;

var AiUWindowDialogClientWindow	NotifyWindow;
var string Text;
var int Font;
var color TextColor;
var TextAlign Align;
...
var AiUWindowDialogControl	TabNext;
var AiUWindowDialogControl	TabPrev;
...
function Register(AiUWindowDialogClientWindow	W)
{
	NotifyWindow = W;
	Notify(DE_Created);
}
...
function AiUWindowDialogControl CheckExternalDrag(float X, float Y)
{
...
{
	local PlayerPawn P;
	local AiUWindowDialogControl N;
