...
param(
    ...
    [ValidateSet('GOTO','GOTOVEC','FIRE','FROB','DAMAGE','OPEN','CONVERSE','ADVANCE','STATUS','MAGSTATE','CONDUMP','SETFLAG','WAITFLAG','NEWGAME','RAW','WHERE','FLAGS','PROBE','TESTENDING','SHOT','QUIT')]
    [string]$Cmd,
    [string]$Arg = ""
)
