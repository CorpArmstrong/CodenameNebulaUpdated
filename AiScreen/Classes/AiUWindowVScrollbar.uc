//=============================================================================
// AiUWindowVScrollBar - A vertical scrollbar
//=============================================================================
class AiUWindowVScrollBar extends AiUWindowWindow;

var AiUWindowSBUpButton		UpButton;
var AiUWindowSBDownButton		DownButton;
var bool					bDisabled;
var float					MinPos;
var float					MaxPos;
...
{
	Super.Created();
	UpButton = AiUWindowSBUpButton(CreateWindow(class'AiUWindowSBUpButton', 0, 0, 12, 10));
	DownButton = AiUWindowSBDownButton(CreateWindow(class'AiUWindowSBDownButton', 0, WinHeight-10, 12, 10));
}
