...
//
//-----------------------------------------------------------
class AiWeaponMiniCrossbowZyme extends AiWeapon;
...
DefaultProperties
{
     ...
     bCanHaveLaser=True
     bHasSilencer=True
     AmmoNames(0)=Class'ApocalypseInside.AiAmmoDartPoisonZyme'
     ProjectileNames(0)=Class'ApocalypseInside.AiDartZyme'
     ...
     AmmoName=Class'ApocalypseInside.AiAmmoDartPoisonZyme'
     ReloadCount=4
     PickupAmmoCount=4
