class AiUWindowComboControl extends AiUWindowDialogControl;

var	float				EditBoxWidth;
var float				EditAreaDrawX, EditAreaDrawY;

var AiUWindowEditBox		EditBox;
var AiUWindowComboButton	Button;
var AiUWindowComboLeftButton LeftButton;
var AiUWindowComboRightButton RightButton;

var class<AiUWindowComboList>	ListClass;
var AiUWindowComboList	List;
...
function Created()
{
	...
	EditBox = AiUWindowEditBox(CreateWindow(class'AiUWindowEditBox', 0, 0, WinWidth-12, WinHeight));
	EditBox.NotifyOwner = Self;
	EditBoxWidth = WinWidth / 2;
	EditBox.bTransient = True;

	Button = AiUWindowComboButton(CreateWindow(class'AiUWindowComboButton', WinWidth-12, 0, 12, 10));
	Button.Owner = Self;
	
	List = AiUWindowComboList(Root.CreateWindow(ListClass, 0, 0, 100, 100));
...
function SetButtons(bool bInButtons)
{
	...
	if(bInButtons)
	{
		LeftButton = AiUWindowComboLeftButton(CreateWindow(class'AiUWindowComboLeftButton', WinWidth-12, 0, 12, 10));
		RightButton = AiUWindowComboRightButton(CreateWindow(class'AiUWindowComboRightButton', WinWidth-12, 0, 12, 10));
	}
	else
	{
		LeftButton = None;
...
defaultproperties
{
     ListClass=class'AiUWindow.UWindowComboList'
     bNoKeyboard=True
}
