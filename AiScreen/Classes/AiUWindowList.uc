...
//=============================================================================
class AiUWindowList extends AiUWindowBase;

var AiUWindowList	Next;
var AiUWindowList	Last;		// Only valid for sentinel
var AiUWindowList	Prev;
var AiUWindowList	Sentinel;
...
var AiUWindowList CurrentSortItem;

// Binary tree variables for sentinel
var bool		bTreeSort;

// Binary tree variables for each element
var AiUWindowList BranchLeft;
var AiUWindowList BranchRight;
var AiUWindowList ParentNode;
...
function AiUWindowList CreateItem(Class<AiUWindowList> C)
{
	local AiUWindowList NewElement;

	NewElement = New C;
	return NewElement;
}

function GraftLeft(AiUWindowList NewLeft)
{
...
function GraftRight(AiUWindowList NewRight)
{
	assert(Sentinel.bTreeSort);
...
function AiUWindowList RightMost()
{
	local AiUWindowList L;
...
function AiUWindowList LeftMost()
{
	local AiUWindowList L;
...
function AiUWindowList InsertBefore(Class<AiUWindowList> C)
{
	local AiUWindowList NewElement;
...
function AiUWindowList InsertAfter(Class<AiUWindowList> C)
{
	local AiUWindowList NewElement;
...
function InsertItemBefore(AiUWindowList NewElement)
{
...
function InsertItemAfter(AiUWindowList NewElement, optional bool bCheckShowItem)
{
	local AiUWindowList N;
...
function AiUWindowList Sort()
{
	local AiUWindowList S;
	local AiUWindowList CurrentItem;
	local AiUWindowList Previous;
	local AiUWindowList Best;
	local AiUWindowList BestPrev;
...
function AiUWindowList CopyExistingListItem(Class<AiUWindowList> ItemClass, AiUWindowList SourceItem)
{
	local AiUWindowList I;
...
function MoveItemSorted(AiUWindowList Item)
{
	local AiUWindowList L;
...
function Validate()
{
	local AiUWindowList I, Previous;
	local int Count;
...
// For sentinel only
function AiUWindowList Append(Class<AiUWindowList> C)
{
	local AiUWindowList NewElement;
...
function AppendItem(AiUWindowList NewElement)
{
	local AiUWindowList Node, OldNode, Temp;
	local int Test;
...
function DoAppendItem(AiUWindowList NewElement)
{
...
// For sentinel only
function AiUWindowList Insert(Class<AiUWindowList> C)
{
	local AiUWindowList NewElement;
...
function InsertItem(AiUWindowList NewElement)
{
...
// For sentinel only
function AiUWindowList FindEntry(int Index)
{
	local AiUWindowList l;
	local int i;
...
function AppendListCopy(AiUWindowList L)
{
	if(L == None)
		return;
