...
function ComboList_DrawBackground(AiUWindowComboList W, Canvas C)
{
	...
	W.DrawStretchedTexture(C, 4, 0, W.WinWidth-8, 4, Texture'MenuT');
	W.DrawClippedTexture(C, W.WinWidth-4, 0, Texture'MenuTR');

	W.DrawClippedTexture(C, 0, W.WinHeight-4, Texture'MenuBL');
	W.DrawStretchedTexture(C, 4, W.WinHeight-4, W.WinWidth-8, 4, Texture'MenuB');
	W.DrawClippedTexture(C, W.WinWidth-4, W.WinHeight-4, Texture'MenuBR');

	W.DrawStretchedTexture(C, 0, 4, 4, W.WinHeight-8, Texture'MenuL');
	W.DrawStretchedTexture(C, W.WinWidth-4, 4, 4, W.WinHeight-8, Texture'MenuR');

	W.DrawStretchedTexture(C, 4, 4, W.WinWidth-8, W.WinHeight-8, Texture'MenuArea');
}
...
{
	W.DrawStretchedTexture( C, 16, 0, W.WinWidth - 32, 16, Texture'MenuBar');
}
...
{
	W.DrawClippedTexture(C, 0, 0, Texture'MenuTL');
	W.DrawStretchedTexture(C, 2, 0, W.WinWidth-4, 2, Texture'MenuT');
	W.DrawClippedTexture(C, W.WinWidth-2, 0, Texture'MenuTR');

	W.DrawClippedTexture(C, 0, W.WinHeight-2, Texture'MenuBL');
	W.DrawStretchedTexture(C, 2, W.WinHeight-2, W.WinWidth-4, 2, Texture'MenuB');
	W.DrawClippedTexture(C, W.WinWidth-2, W.WinHeight-2, Texture'MenuBR');

	W.DrawStretchedTexture(C, 0, 2, 2, W.WinHeight-4, Texture'MenuL');
	W.DrawStretchedTexture(C, W.WinWidth-2, 2, 2, W.WinHeight-4, Texture'MenuR');
	W.DrawStretchedTexture(C, 2, 2, W.WinWidth-4, W.WinHeight-4, Texture'MenuArea');
}
...
function Menu_DrawPulldownMenuItem(AiUWindowPulldownMenu M, AiUWindowPulldownMenuItem Item, Canvas C, float X, float Y, float W, float H, bool bSelected)
{
	...
	if(Item.Caption == "-")
	{
		...
		C.DrawColor.G = 255;
		C.DrawColor.B = 255;
		M.DrawStretchedTexture(C, X, Y+5, W, 2, Texture'MenuDivider');
		return;
	}
...
defaultproperties
{
     ...
     Active=Texture'ActiveFrame'
     Inactive=Texture'InactiveFrame'
     ActiveS=Texture'ActiveFrameS'
     InactiveS=Texture'InactiveFrameS'
     Misc=Texture'Misc'
     FrameTL=(W=2,H=16)
